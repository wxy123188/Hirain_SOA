...
public class SwipeMenuLayout extends ViewGroup {
    ...
    private SwipeeMenuMoveListener swipeeMenuMoveListener;
    ...
    public interface SwipeeMenuMoveListener{
        //菜单打开
        void menuOpen();
        //菜单关闭
        void menuClose();
    ...
    public void setSwipeeMenuMoveListener(SwipeeMenuMoveListener swipeeMenuMoveListener){
        this.swipeeMenuMoveListener=swipeeMenuMoveListener;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        if(swipeeMenuMoveListener!=null){
            swipeeMenuMoveListener.menuOpen();
        }
        cancelAnim();
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        if(swipeeMenuMoveListener!=null){
            swipeeMenuMoveListener.menuClose();
        }
